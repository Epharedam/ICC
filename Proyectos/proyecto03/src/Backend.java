public class Backend {
     ...
     */
    public static void startBackend(List<Catalogo> catList) throws IOException, ClassNotFoundException {
        createMainDir();
        readAllCats(catList);
    }
     ...
     * @throws ClassNotFoundException
     */
    private static void readAllCats(List<Catalogo> catList) throws IOException, ClassNotFoundException {
        ...
        for (String s : myFiles) {
            try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("Catalogues/" + s))) {
                Catalogo cat = (Catalogo) ois.readObject();
                catList.add(cat);
            }
        }
    }
     ...
     * @throws IOException
     */
    public static void save(List<Catalogo> catList) throws FileNotFoundException, IOException {
        for (File f : new File("Catalogues").listFiles()) {//Delete all files from directory
            f.delete();
        }
        for (Catalogo c : catList) {//add all catalogues to directory
     ...
     * @return
     */
    public static boolean renameCatalogue(Catalogo catalogue, String newName, List<Catalogo> catList) {
        for (Catalogo c : catList) {
     ...
     */
    private static int getCatIndex(String catName, List<Catalogo> catList) {
        for (Catalogo c : catList) {
     ...
     */
    public static boolean deleteCatalogue(String catName, List<Catalogo> catList) {
     ...
     */
    private static boolean isInCatList(String catName, List<Catalogo> catList) {
        for (Catalogo c : catList) {
            if (c.getCatName().equalsIgnoreCase(catName)) {
                return true;
            }
     ...
     */
    public static boolean addCatalogue(Catalogo catName, List<Catalogo> catList) {
...
//</editor-fold>
    ...
    public static int generateMultimediaId(Catalogo catToUse) {
        int id = 1;
     ...
     */
    public static boolean addMultimedia(int id, String multimediaName, File multimediaTextFileLocation, File mulimediaImgFileLocation, Catalogo catToAddTo, List<Catalogo> catList) throws IOException {
     ...
     */
    public static boolean removeMultimedia(int multimediaToRemove, String catalogueToUse, List<Catalogo> catList) {
        for (Catalogo c : catList) {
     ...
     */
    public static boolean editMultimedia(int multimediaToChange, String newName, File newImageFile, File newTextFileName, String catalogueToUse, List<Catalogo> catList) {
        for (Catalogo c : catList) {
            if (c.getCatName().equalsIgnoreCase(catalogueToUse)) {
...
//</editor-fold>
     ...
     * @throws IOException
     */
    private static void mainMenu(List<Catalogo> listName) throws IOException {
     ...
     * @throws IOException
     */
    private static void addCat(List<Catalogo> listName) throws IOException {
        ...
        if (addCatalogue(new Catalogo(input), listName)) {
     ...
     * @throws IOException
     */
    private static void searchCat(List<Catalogo> listName) throws IOException {
        System.out.print("Enter catalogue name: ");
        Scanner kb = new Scanner(System.in);
        String input = kb.nextLine();
        while (input.trim().isEmpty()) {
     ...
     * @throws IOException
     */
    private static void editCat(List<Catalogo> listName, String catName) throws IOException {
        ...
        if (renameCatalogue(new Catalogo(catName), input, listName)) {
     ...
     * @throws IOException
     */
    private static void deleteCat(List<Catalogo> listName, String catName) throws IOException {
     ...
     * @throws IOException
     */
    private static void viewCat(List<Catalogo> listName, String catName) throws IOException {
        System.out.println("Catalogue details of " + catName);
        for (Catalogo c : listName) {
            if (c.getCatName().equalsIgnoreCase(catName)) {
     ...
     * @throws IOException
     */
    private static void multMenu(List<Catalogo> listName, String catName) throws IOException {
     ...
     * @throws IOException
     */
    private static void addMult(List<Catalogo> listName, String catName) throws IOException {
     ...
     * @throws IOException
     */
    private static void searchMultimedia(List<Catalogo> listName, String catName) throws IOException {
     ...
     * @throws IOException
     */
    private static void editMultName(int id, String catName, List<Catalogo> listName) throws IOException {
     ...
     * @throws IOException
     */
    private static void deleteMult(int id, String catName, List<Catalogo> listName) throws IOException {
    ...
    public static void main(String[] args) throws IOException, FileNotFoundException, ClassNotFoundException {
        List<Catalogo> cats = new ArrayList<>();
        startBackend(cats);
        mainMenu(cats);
